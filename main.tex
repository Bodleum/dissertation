...
Where possible, the names of specific, and families of groups are given.
    ...
    A table of the full classification is found in the \hyperlink{ch:appendix}{Appendix}.
...
The content of \textit{MT4003} will be assumed knowledge, however this material can be found in group theory
...
Finally, let's deal with the groups of particular order which have been missed by our general classifications.
